...
//        configuration.setAllowedOrigins(Arrays.asList("*"));
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "https://example.com", "http://103.72.96.37:8001/", "https://batdongsan.hoclaptrinhiz.com/", "http://batdongsan.hoclaptrinhiz.com/"));
