...
import {auctionSelector, joinAuctionRoom, removeBidMessages, removeUsers} from "../../redux/reducers/auctionReducer";
...
const RoomAuctionComponent = ({pageSize}) => {
    ...
    const handleRoomChange = (roomId, item) => {
        ...
        if(status === appVariables.BEFORE){
            appVariables.toast_notify_error("Bạn không thể vào. Phiên đấu giá này chưa bắt đầu!", 2000);
            return;
        }
        if(!item?.active){
