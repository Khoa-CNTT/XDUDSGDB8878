...
const AuctionHistoryScreen = () => {
    ...
    const handleAcceptance = async (auctionKey) =>{
        ...
        await handleAPI(`/api/admin/handle-acceptance-auction-histories/${auctionKey}`, {}, "PATCH", auth?.token)
            .then(res => {
                                                ...
                                                <div style={{textAlign: 'center'}}>
                                                    {
                                                        ...
                                                        appVariables.NEW ?
                                                    (<span>
                                                        <img width={'50%'} src={appInfo?.newIcon} alt="new"/>
                                                    </span>) : (
                                                    <span>
                                                        <img width={'50%'} src={appInfo?.oldIcon} alt="old"/>
                                                    </span>)
                                                    }
                                                </div>
                                            </td>
