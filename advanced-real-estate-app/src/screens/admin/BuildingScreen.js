                                                ...
                                                <div className='col-8'>
                                                    ...
                                                    <div className='row'>
                                                        <div className='col'>
                                                            ...
                                                            <textarea style={{height: "470px"}} rows="10"
                        ...
                        <table className="table table-bordered">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body ">
                                                                <span>Bạn có chắc chắn muốn xóa <span
                                                                    className="text-danger">{listCheckBox.length}</span> kiểu toàn nhà này không?</span>
                                                            </div>
                            ...
                            <tbody>
                            {
                                    buildings.map((value, key) => (
                                        <>
                                            <tr className={listCheckBox.includes(value.id) ? "table-secondary" : ""}>
                                                <td key={value?.id} className="text-center align-middle" style={{width: "60px"}}>
                                                    <Checkbox
                                                ...
                                                <td className="align-middle text-center">{value.area} m²</td>
