...
<p align="center">Giải pháp toàn diện để quản lý, theo dõi và tương tác với bất động sản theo cách hiện đại, kết hợp công nghệ AI và giao diện người dùng thân thiện.</p>
...
| 🐳 Docker | 🌀 Spring Boot | ⚛️ React | 🤖 Gemini AI | 🐍 Flask | 🧠 DeepSeek AI |
|:---------:|:--------------:|:--------:|:------------:|:--------:|:--------------:|
...
| 🔄 Tối ưu giao tiếp | 🚀 Cải thiện hiệu suất AI | 🐛 Sửa lỗi kết nối | 📦 Tăng khả năng triển khai |
|:-------------------:|:-------------------------:|:------------------:|:---------------------------:|
| Giữa Flask và Spring Boot thông qua API Gateway | Khi sử dụng kết hợp DeepSeek và Gemini | Giữa ReactJS và Flask API | Linh hoạt với Docker Compose |
    ...
    <tr>
      <td align="center">
        <a href="https://github.com/ngockhanhnktech">
          <img src="https://github.com/ngockhanhnktech.png" width="100px;" alt="Nguyễn Ngọc Khánh"/>
          <br />
          <sub><b>Nguyễn Ngọc Khánh</b></sub>
        </a>
        <br />
      ...
      <td align="center">
        <a href="https://github.com/vanmanh1303">
          <img src="https://github.com/vanmanh1303.png" width="100px;" alt="Phùng Văn Mạnh"/>
          <br />
          <sub><b>Phùng Văn Mạnh</b></sub>
        </a>
        <br />
        <sub>@vanmanh1303</sub>
      </td>
      <td align="center">
        <a href="https://github.com/namNguyen212003">
          <img src="https://github.com/namNguyen212003.png" width="100px;" alt="Nguyễn Khắc Hoài Nam"/>
          <br />
          <sub><b>Nguyễn Khắc Hoài Nam</b></sub>
        </a>
        <br />
    ...
    <tr>
      <td align="center">
        <a href="https://github.com/ntiendev">
          <img src="https://github.com/ntiendev.png" width="100px;" alt="Trần Ngọc Tiến"/>
          <br />
          <sub><b>Trần Ngọc Tiến</b></sub>
        </a>
        <br />
        <sub>@ntiendev</sub>
      </td>
      <td align="center">
        <a href="https://github.com/tuongclearlove7">
          <img src="https://github.com/tuongclearlove7.png" width="100px;" alt="Trần Thế Tường"/>
          <br />
          <sub><b>Trần Thế Tường</b></sub>
        </a>
        <br />
